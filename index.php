...
<body class="animsition">
	...
	<!-- Slider -->
	<?php include ("storage/slider.php"); ?>


	<!-- Banner -->
	<?php include ("storage/banner.php"); ?>
		...
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".<?php echo $row2['id'] ?>">
					<?php echo $row2['name'] ?>
					</button>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $row['category_id'];?>">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							...
							<a href="details.php?detail_id=<?php echo $row['id'] ?>" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 ">
								Quick View
							</a>
						</div>
